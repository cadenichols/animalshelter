...
module.exports = [
  ...
  {method: 'get', path: '/clients/{animalId}', config: require('../routes/clients/show')},
  {method: 'post', path: '/clients/{animalId}/delete', config: require('../routes/clients/destroy')},
  {method: 'get', path: '/clients/{animalId}/edit', config: require('../routes/clients/edit')}
